        ...
        <>
          ...
          <div className="absolute top-full left-0 right-0 bg-white border-b border-wire-border shadow-md z-40">
            <div className="px-5 py-4 flex flex-col gap-1">
              ...
              <Link href="/docs/getting-started" className="py-2 text-sm text-wire-slate hover:text-wire-navy transition-colors" onClick={() => setOpen(false)}>Quick start guide</Link>
